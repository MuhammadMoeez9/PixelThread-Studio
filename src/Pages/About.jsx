  ...
  return (
    <>
      <div id="main">
        ...
        <nav>
          <img src="./Assets/300x100-01.png" alt="" />
          <div id="links">
              ...
              <div id="offer">
                ...
                <div id="offers">
                  <p>
                    ...
                    files, ensuring seamless results for apparel, merchandise,
                    and branding needs. <br />
                    <br />
        ...
        <div id="journey">
          <div className="service-story">
            ...
            <div className="s-right">
              ...
              <p>
                We provide high-quality embroidery digitizing services, ensuring
                smooth, precise, and detailed stitch files. Our clients have
                achieved flawless embroidery results, enhancing their brand
          ...
          <div className="service-story">
            <div className="s-right">
              ...
              <p>
                ...
                durable, and high-resolution prints on various fabrics. Clients
                have seen a significant boost in their apparel business due to
                the premium quality and long-lasting results.
              </p>
            </div>
            <div className="s-left">
          ...
          <div className="service-story">
            <div className="s-right">
              ...
              <p>
                ...
                have strengthened their brand identity with our premium patches,
                making their products more attractive and professional.
              </p>
            </div>
            <div className="s-left">
              <img src="./Assets/about-image-02.png" alt="" />
